              ...
              <tr>
                <td align="center">
                  <a href="localhost/msport/" target="self" class="linkBlock_iq0Zu">
                    <img src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExdjZyaTg3MjBhODhvdmZ1b2Q1Yzl3NTY4a2F5ZThqZnY4NnJ5Z2p2cyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/O67w2LwW6zvrsAY2l7/giphy.gif" alt="" width="50%" height="50%">
                  </a>
            ...
            <tbody>
              ...
              <tr>
                <td align="center" style="color:#5a5a5a;padding:20px 40px 0 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:normal;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;" class="table-container">
                  We're thrilled to let you know that your purchase has been successfully processed. Here's a summary of your order:
                </td>
              </tr>
            </tbody>
          </table>
                  ...
                  <tbody>
                    <?php foreach ($products as $item) : ?>
                      <?php if (isset($item['id'])) : ?>
                        <tr>
                          <td bgcolor="#FFF" width="40" align="left" style="color:#5a5a5a;padding:10px 0;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                          </td>
                          <td bgcolor="#FFFFFF" align="left" style="color:#5a5a5a;padding:10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:normal;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                            <?= $item['name'] ?> (<?= isset($item['quantity']) ? $item['quantity'] : 'N/A' ?>)
                          </td>
                          <td bgcolor="#FFFFFF" align="right" style="color:#5a5a5a;padding:10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                          <td bgcolor="#FFFFFF" align="right" style="color:#5a5a5a;padding:10px 40px;font-family: 'Lato', Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                            <?php
                            if (isset($item['price']) && is_array($item['price']) && count($item['price']) == 2) {
                              $original_price = $item['price'][0];
                              $discounted_price = $item['price'][1];
                            ?>
                              <del><?php echo $original_price; ?></del> <?php echo $discounted_price; ?>
                            <?php
            ...
            <tbody>
              ...
              <tr>
                <td align="left" valign="top" style="color: #111111; font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 14px;font-weight:normal;">
                  <?php echo $address . ',' . $city . ','  . $address . ','  . $postcode . ','; ?>
                </td>
              </tr>
            </tbody>
          </table>
